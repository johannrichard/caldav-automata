...
def tentative_invite(_event, inbox_item=None) -> bool:
    ...
    logger.info('Tentatively accepted invite from inbox item %s', getattr(inbox_item, 'url', '?'))
    return True
        ...
        if extra:
            ...
            for i in range(0, len(extra), 2):
                ...
                if key not in option_keys:
                    ...
                    return False
                canonical = 'schedule_agent' if key in {'schedule-agent', 'schedule_agent'} else key
